...
def main():
    ...
    def getHTML(row):
        return "<b> Place: %s </b>" % row['pow_name']

    map["html_to_display"] = map.apply(getHTML, axis=1)
    ...
    popup = folium.features.GeoJsonPopup(
        # Replaced fields and aliases with my own 'html_to_dsplay'
        # fields=["name", "medianincome", "change"],
        # aliases=["State:", "2015 Median Income(USD):", "Median % Change:"],
        # labels=True,
        labels=False,
        fields=["html_to_display"],
        localize=True,
